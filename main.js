...
import { chainMultiplicationOfMatrices, findPathInFord, floyd } from "./algorithmsCategories/dynamicProgramming/DynamicAlgorithm";
...
console.log(JSON.parse(JSON.stringify(adjacencyMatrix)));
